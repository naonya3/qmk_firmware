...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RALT, KC_UP,  MO(1),   \
    KC_ESC,    KC_LCTL,    KC_LALT,   LGUI_T(KC_TAB), KC_SPC,    KC_BSPC,   SFT_T(KC_ENT),  LGUI_T(KC_SPC),  KC_LEFT, KC_DOWN, KC_RGHT \
  ),
  [1] = LAYOUT( \
